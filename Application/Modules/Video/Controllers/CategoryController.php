 ...
 */
class CategoryController extends XPHP_Controller
{
    ...
    #[Authorize]
    public function createPost(Category $model)
    {
        if ($model->validate())
        {
    ...
    #[Authorize]
    public function editPost(Category $model)
    {
        if ($model->validate())
        {
            if ($model->update())
    ...
    #[Authorize]
    public function deletePost(Category $model)
    {
        if($model->delete())
            return $this->json(
                array('success' => true,
