<?php
        ...
        $mcImageManagerConfig['filesystem.path'] = '../../../../Data/files'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = '../../../../Data/files'; // absolute or relative from this script path, required.
        ...
        $mcImageManagerConfig['filesystem.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,doc,docx,xls,xlsx,ppt,pptx";
        ...
        $mcImageManagerConfig['upload.extensions'] = "gif,jpg,jpeg,png,swf,doc,docx,xls,xlsx,ppt,pptx";
