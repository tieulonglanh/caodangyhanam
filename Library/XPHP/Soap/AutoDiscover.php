 ...
 * @see XPHP_Soap_Wsdl
 */
require_once 'XPHP/Soap/Wsdl.php';
/**
 * @see XPHP_Server_Reflection
 */
require_once 'XPHP/Server/Reflection.php';
/**
 * @see XPHP_Server_Abstract
 */
require_once 'XPHP/Server/Abstract.php';
/**
 * @see XPHP_Uri
 */
...
/**
 * XPHP_Soap_AutoDiscover
 *
 * @category   XPHP
 * @package    XPHP_Soap
 * @subpackage AutoDiscover
 */
class XPHP_Soap_AutoDiscover
{
    /**
     * @var XPHP_Soap_Wsdl
     */
     ...
     * Constructor
     *
     * @param boolean|string|XPHP_Soap_Wsdl_Strategy_Interface $strategy
     * @param string|XPHP_Uri $uri
     */
     ...
     *
     * @see XPHP_Soap_Exception
     * @param  XPHP_Uri|string $uri
     * @return XPHP_Soap_AutoDiscover
     * @throws XPHP_Soap_AutoDiscover_Exception
     */
    public function setUri($uri)
    {
        if (!is_string($uri) && !($uri instanceof XPHP_Uri)) {
            require_once "XPHP/Soap/AutoDiscover/Exception.php";
            throw new XPHP_Soap_AutoDiscover_Exception("No uri given to XPHP_Soap_AutoDiscover::setUri as string or XPHP_Uri instance.");
        }
        $this->_uri = $uri;

        // change uri in WSDL file also if existant
        if ($this->_wsdl instanceof XPHP_Soap_Wsdl) {
    ...
    public function getUri()
    {
        if($this->_uri !== null) {
            ...
            $uri = XPHP_Uri::factory($schema . '://' . $host . $scriptName);
            $this->setUri($uri);
        }
        return $uri;
    }
     ...
     *
     * @see    XPHP_Soap_AutoDiscover_Exception
    ...
    public function setOperationBodyStyle(array $operationStyle=array())
    {
        if(!isset($operationStyle['use'])) {
            require_once "XPHP/Soap/AutoDiscover/Exception.php";
            throw new XPHP_Soap_AutoDiscover_Exception("Key 'use' is required in Operation soap:body style.");
        }
    ...
    public function setClass($class, $namespace = '', $argv = null)
    {
        ...
        $wsdl = new XPHP_Soap_Wsdl($class, $uri, $this->_strategy);
    ...
    public function addFunction($function, $namespace = '')
    {
        ...
        if (!($this->_wsdl instanceof XPHP_Soap_Wsdl)) {
            ...
            $name = $parts[0];
            $wsdl = new XPHP_Soap_Wsdl($name, $uri, $this->_strategy);
     ...
     *
     * @param $function XPHP_Server_Reflection_Function_Abstract function to add
     * @param $wsdl XPHP_Soap_Wsdl WSDL document
    ...
    protected function _addFunctionToWsdl($function, $wsdl, $port, $binding)
    {
        ...
        if ($prototype === null) {
            require_once "XPHP/Soap/AutoDiscover/Exception.php";
            throw new XPHP_Soap_AutoDiscover_Exception("No prototypes could be found for the '" . $function->getName() . "' function");
        }
    ...
    {
        require_once "XPHP/Soap/AutoDiscover/Exception.php";
        throw new XPHP_Soap_AutoDiscover_Exception("Function has no use in AutoDiscover.");
    }
    ...
    public function dump($filename)
    {
        if($this->_wsdl !== null) {
             ...
             */
            require_once "XPHP/Soap/AutoDiscover/Exception.php";
            throw new XPHP_Soap_AutoDiscover_Exception("Cannot dump autodiscovered contents, WSDL file has not been generated yet.");
        }
    }
    ...
    public function toXml()
    {
        if($this->_wsdl !== null) {
             ...
             */
            require_once "XPHP/Soap/AutoDiscover/Exception.php";
            throw new XPHP_Soap_AutoDiscover_Exception("Cannot return autodiscovered contents, WSDL file has not been generated yet.");
        }
    }
