 ...
 * @version    $Id: ArrayOfTypeComplex.php 20784 2010-01-31 08:22:51Z yoshida@XPHP.co.jp $
 */

/**
 * @see XPHP_Soap_Wsdl_Strategy_DefaultComplexType
 */
require_once "XPHP/Soap/Wsdl/Strategy/DefaultComplexType.php";

/**
 * XPHP_Soap_Wsdl_Strategy_ArrayOfTypeComplex
 *
 * @category   XPHP
 * @package    XPHP_Soap
 * @subpackage Wsdl
 ...
 * @license    http://framework.XPHP.com/license/new-bsd     New BSD License
 */
class XPHP_Soap_Wsdl_Strategy_ArrayOfTypeComplex extends XPHP_Soap_Wsdl_Strategy_DefaultComplexType
{
    ...
    public function addComplexType($type)
    {
        if(in_array($type, $this->_inProcess)) {
            ...
            throw new XPHP_Soap_Wsdl_Exception("Infinite recursion, cannot nest '".$type."' into itself.");
        }
