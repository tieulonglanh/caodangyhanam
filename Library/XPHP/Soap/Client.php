...
/**
 * @see XPHP_Soap_Server
 */
require_once 'XPHP/Soap/Server.php';

/**
 * @see XPHP_Soap_Client_Local
 */
require_once 'XPHP/Soap/Client/Local.php';

/**
 * @see XPHP_Soap_Client_Common
 */
require_once 'XPHP/Soap/Client/Common.php';
...
class XPHP_Soap_Client
{
     ...
     * It also defines XPHP_Soap_Client working mode (WSDL vs non-WSDL)
     *
     * @var string
     */
    ...
    public function __construct($wsdl = null, $options = null)
    {
        if (!extension_loaded('soap')) {
            require_once 'XPHP/Soap/Client/Exception.php';
            throw new XPHP_Soap_Client_Exception('SOAP extension is not loaded.');
        }
     ...
     *
     * @param  array|XPHP_Config $options
     * @return XPHP_Soap_Client
     * @throws XPHP_SoapClient_Exception
     */
    public function setOptions($options)
    {
        ...
        foreach ($options as $key => $value) {
            switch ($key) {
                ...
                default:
                    require_once 'XPHP/Soap/Client/Exception.php';
                    throw new XPHP_Soap_Client_Exception('Unknown SOAP client option');
                    break;
            }
        }
     ...
     * @return XPHP_Soap_Client
     * @throws XPHP_Soap_Client_Exception with invalid soap version argument
     */
    public function setSoapVersion($version)
    {
        if (!in_array($version, array(SOAP_1_1, SOAP_1_2))) {
            require_once 'XPHP/Soap/Client/Exception.php';
            throw new XPHP_Soap_Client_Exception('Invalid soap version specified. Use SOAP_1_1 or SOAP_1_2 constants.');
        }
     ...
     * @return XPHP_Soap_Client
     * @throws XPHP_Soap_Client_Exception for any invalid class in the class map
     */
    public function setClassmap(array $classmap)
    {
        foreach ($classmap as $type => $class) {
            if (!class_exists($class)) {
                require_once 'XPHP/Soap/Client/Exception.php';
                throw new XPHP_Soap_Client_Exception('Invalid class in class map');
            }
        }
     ...
     * @return XPHP_Soap_Client
     * @throws XPHP_Soap_Client_Exception with invalid encoding argument
     */
    public function setEncoding($encoding)
    {
        if (!is_string($encoding)) {
            require_once 'XPHP/Soap/Client/Exception.php';
            throw new XPHP_Soap_Client_Exception('Invalid encoding specified');
        }
     ...
     * @param  string $urn
     * @return true
     * @throws XPHP_Soap_Client_Exception on invalid URN
     */
    public function validateUrn($urn)
    {
        ...
        if ($scheme === false || $scheme === null) {
            require_once 'XPHP/Soap/Client/Exception.php';
            throw new XPHP_Soap_Client_Exception('Invalid URN');
        }
     ...
     * @param  string $uri
     * @return XPHP_Soap_Client
     * @throws XPHP_Soap_Client_Exception with invalid uri argument
     */
     ...
     * @return XPHP_Soap_Client
     * @throws XPHP_Soap_Client_Exception with invalid style argument
     */
    public function setStyle($style)
    {
        if (!in_array($style, array(SOAP_RPC, SOAP_DOCUMENT))) {
            require_once 'XPHP/Soap/Client/Exception.php';
            throw new XPHP_Soap_Client_Exception('Invalid request style specified. Use SOAP_RPC or SOAP_DOCUMENT constants.');
        }
     ...
     * @return XPHP_Soap_Client
     * @throws XPHP_Soap_Client_Exception with invalid message encoding method argument
     */
    public function setEncodingMethod($use)
    {
        if (!in_array($use, array(SOAP_ENCODED, SOAP_LITERAL))) {
            require_once 'XPHP/Soap/Client/Exception.php';
            throw new XPHP_Soap_Client_Exception('Invalid message encoding method. Use SOAP_ENCODED or SOAP_LITERAL constants.');
        }
     ...
     * @return XPHP_Soap_Client
     * @throws XPHP_Soap_Client_Exception with invalid local certificate path argument
     */
    public function setHttpsCertificate($localCert)
    {
        if (!is_readable($localCert)) {
            require_once 'XPHP/Soap/Client/Exception.php';
            throw new XPHP_Soap_Client_Exception('Invalid HTTPS client certificate path.');
        }
    ...
    public function setStreamContext($context)
    {
        if(!is_resource($context) || get_resource_type($context) !== "stream-context") {
            /**
             * @see XPHP_Soap_Client_Exception
             */
            require_once "XPHP/Soap/Client/Exception.php";
            throw new XPHP_Soap_Client_Exception(
     ...
     *
     * @internal
     * @param XPHP_Soap_Client_Common $client
     ...
     * @return mixed
     */
    public function _doRequest(XPHP_Soap_Client_Common $client, $request, $location, $action, $version, $one_way = null)
    {
     ...
     *
     * @throws XPHP_Soap_Client_Exception
     */
    protected function _initSoapClientObject()
    {
        ...
        if ($wsdl == null) {
            if (!isset($options['location'])) {
                require_once 'XPHP/Soap/Client/Exception.php';
                throw new XPHP_Soap_Client_Exception('\'location\' parameter is required in non-WSDL mode.');
            }
            if (!isset($options['uri'])) {
                require_once 'XPHP/Soap/Client/Exception.php';
                throw new XPHP_Soap_Client_Exception('\'uri\' parameter is required in non-WSDL mode.');
            }
        } else {
            if (isset($options['use'])) {
                require_once 'XPHP/Soap/Client/Exception.php';
                throw new XPHP_Soap_Client_Exception('\'use\' parameter only works in non-WSDL mode.');
            }
            if (isset($options['style'])) {
                require_once 'XPHP/Soap/Client/Exception.php';
                throw new XPHP_Soap_Client_Exception('\'style\' parameter only works in non-WSDL mode.');
            }
        }
        unset($options['wsdl']);

        $this->_soapClient = new XPHP_Soap_Client_Common(array($this, '_doRequest'), $wsdl, $options);
    }
    ...
    public function getFunctions()
    {
        if ($this->getWsdl() == null) {
            require_once 'XPHP/Soap/Client/Exception.php';
            throw new XPHP_Soap_Client_Exception('\'getFunctions\' method is available only in WSDL mode.');
        }
    ...
    public function getTypes()
    {
        if ($this->getWsdl() == null) {
            require_once 'XPHP/Soap/Client/Exception.php';
            throw new XPHP_Soap_Client_Exception('\'getTypes\' method is available only in WSDL mode.');
        }
