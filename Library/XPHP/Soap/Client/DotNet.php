 ...
 * suggestions in fw-webservices@lists.XPHP.com or fw-general@lists.com
 *
 * @category   XPHP
 * @package    XPHP_Soap
 * @subpackage Client
 */
class XPHP_Soap_Client_DotNet extends XPHP_Soap_Client
{
    /**
     * Constructor
     *
    ...
    protected function _preProcessArguments($arguments)
    {
        if (count($arguments) > 1  ||
            ...
            throw new XPHP_Soap_Client_Exception('.Net webservice arguments have to be grouped into array: array(\'a\' => $a, \'b\' => $b, ...).');
        }
