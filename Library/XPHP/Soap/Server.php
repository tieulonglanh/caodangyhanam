...
/**
 * @see XPHP_Server_Interface
 */
require_once 'XPHP/Server/Interface.php';
...
class XPHP_Soap_Server
{
    ...
    public function __construct($wsdl = null, array $options = null)
    {
        if (!extension_loaded('soap')) {
            require_once 'XPHP/Soap/Server/Exception.php';
            throw new XPHP_Soap_Server_Exception('SOAP extension is not loaded.');
        }
     ...
     * @return XPHP_Soap_Server
     * @throws XPHP_Soap_Server_Exception with invalid encoding argument
     */
    public function setEncoding($encoding)
    {
        if (!is_string($encoding)) {
            require_once 'XPHP/Soap/Server/Exception.php';
            throw new XPHP_Soap_Server_Exception('Invalid encoding specified');
        }
     ...
     * @return XPHP_Soap_Server
     * @throws XPHP_Soap_Server_Exception with invalid soap version argument
     */
    public function setSoapVersion($version)
    {
        if (!in_array($version, array(SOAP_1_1, SOAP_1_2))) {
            require_once 'XPHP/Soap/Server/Exception.php';
            throw new XPHP_Soap_Server_Exception('Invalid soap version specified');
        }
     ...
     * @param  string $urn
     * @return true
     * @throws XPHP_Soap_Server_Exception on invalid URN
     */
    public function validateUrn($urn)
    {
        ...
        if ($scheme === false || $scheme === null) {
            require_once 'XPHP/Soap/Server/Exception.php';
            throw new XPHP_Soap_Server_Exception('Invalid URN');
        }
     ...
     * @param  string $uri
     * @return XPHP_Soap_Server
     * @throws XPHP_Soap_Server_Exception with invalid uri argument
     */
     ...
     * @return XPHP_Soap_Server
     * @throws XPHP_Soap_Server_Exception for any invalid class in the class map
     */
    public function setClassmap($classmap)
    {
        if (!is_array($classmap)) {
            /**
             * @see XPHP_Soap_Server_Exception
             */
            require_once 'XPHP/Soap/Server/Exception.php';
            throw new XPHP_Soap_Server_Exception('Classmap must be an array');
        }
        foreach ($classmap as $type => $class) {
            if (!class_exists($class)) {
                 ...
                 */
                require_once 'XPHP/Soap/Server/Exception.php';
                throw new XPHP_Soap_Server_Exception('Invalid class in class map');
            }
        }
     ...
     * @return XPHP_Soap_Server
     * @throws XPHP_Soap_Server_Exception on invalid functions
     */
        ...
        if (is_array($function)) {
            foreach ($function as $func) {
                if (is_string($func) && function_exists($func)) {
                    ...
                    require_once 'XPHP/Soap/Server/Exception.php';
                    throw new XPHP_Soap_Server_Exception('One or more invalid functions specified in array');
                }
            }
            ...
            require_once 'XPHP/Soap/Server/Exception.php';
            throw new XPHP_Soap_Server_Exception('Invalid function specified');
        }
     ...
     * @return XPHP_Soap_Server
     * @throws XPHP_Soap_Server_Exception if called more than once, or if class
     * does not exist
     */
    public function setClass($class, $namespace = '', $argv = null)
    {
        if (isset($this->_class)) {
            require_once 'XPHP/Soap/Server/Exception.php';
            throw new XPHP_Soap_Server_Exception('A class has already been registered with this soap server instance');
        }

        if (!is_string($class)) {
            require_once 'XPHP/Soap/Server/Exception.php';
            throw new XPHP_Soap_Server_Exception('Invalid class argument (' . gettype($class) . ')');
        }

        if (!class_exists($class)) {
            require_once 'XPHP/Soap/Server/Exception.php';
            throw new XPHP_Soap_Server_Exception('Class "' . $class . '" does not exist');
        }
    ...
    public function setObject($object)
    {
        if(!is_object($object)) {
            require_once 'XPHP/Soap/Server/Exception.php';
            throw new XPHP_Soap_Server_Exception('Invalid object argument ('.gettype($object).')');
        }

        if(isset($this->_object)) {
            require_once 'XPHP/Soap/Server/Exception.php';
            throw new XPHP_Soap_Server_Exception('An object has already been registered with this soap server instance');
        }
     ...
     * @param array $array
     * @return void
     * @throws XPHP_Soap_Server_Exception Unimplemented
     */
    public function loadFunctions($definition)
    {
        require_once 'XPHP/Soap/Server/Exception.php';
        throw new XPHP_Soap_Server_Exception('Unimplemented');
    }
    ...
    public function setPersistence($mode)
    {
        if (!in_array($mode, array(SOAP_PERSISTENCE_SESSION, SOAP_PERSISTENCE_REQUEST))) {
            require_once 'XPHP/Soap/Server/Exception.php';
            throw new XPHP_Soap_Server_Exception('Invalid persistence mode specified');
        }
    ...
    protected function _setRequest($request)
    {
        if ($request instanceof DOMDocument) {
            ...
            if(strlen($xml) == 0 || !$dom->loadXML($xml)) {
                require_once 'XPHP/Soap/Server/Exception.php';
                throw new XPHP_Soap_Server_Exception('Invalid XML');
            }
        }
        $this->_request = $xml;
        return $this;
    ...
    public function handle($request = null)
    {
        ...
        // Set XPHP_Soap_Server error handler
        ...
        } catch (XPHP_Soap_Server_Exception $e) {
