...
class XPHP_Soap_Wsdl
{
    ...
    {
        if ($uri instanceof XPHP_Uri_Http) {
            $uri = $uri->getUri();
        }
        $this->_uri = $uri;
        ...
        if (!$this->_dom->loadXML($wsdl)) {
            ...
            throw new XPHP_Exception('Unable to create DomDocument');
        } else {
     ...
     *
     * @param  string|XPHP_Uri_Http $uri
     * @return XPHP_Server_Wsdl
     */
    ...
    {
        if($strategy === true) {
            require_once "XPHP/Soap/Wsdl/Strategy/DefaultComplexType.php";
            $strategy = new XPHP_Soap_Wsdl_Strategy_DefaultComplexType();
        } else if($strategy === false) {
            require_once "XPHP/Soap/Wsdl/Strategy/AnyType.php";
            $strategy = new XPHP_Soap_Wsdl_Strategy_AnyType();
        ...
        if(!($strategy instanceof XPHP_Soap_Wsdl_Strategy_Interface)) {
            require_once "XPHP/Soap/Wsdl/Exception.php";
            throw new XPHP_Soap_Wsdl_Exception("Set a strategy that is not of type 'XPHP_Soap_Wsdl_Strategy_Interface'");
        }
    ...
    {
        if ($soap_action instanceof XPHP_Uri_Http) {
    ...
    {
        if ($location instanceof XPHP_Uri_Http) {
    ...
    private function _parseElement($element)
    {
        if (!is_array($element)) {
            require_once "XPHP/Soap/Wsdl/Exception.php";
            throw new XPHP_Soap_Wsdl_Exception("The 'element' parameter needs to be an associative array.");
        }
