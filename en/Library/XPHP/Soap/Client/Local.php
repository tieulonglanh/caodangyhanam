...
/** XPHP_Soap_Client */
require_once 'XPHP/Soap/Client.php';

if (extension_loaded('soap')) {

/**
 * XPHP_Soap_Client_Local
 *
 ...
 * @subpackage Client
 */
class XPHP_Soap_Client_Local extends XPHP_Soap_Client
{
    /**
     * Server object
     *
     * @var XPHP_Soap_Server
     */
    protected $_server;
     ...
     *
     * @param XPHP_Soap_Server $server
     * @param string $wsdl
     * @param array $options
     */
    function __construct(XPHP_Soap_Server $server, $wsdl, $options = null)
    {
        $this->_server = $server;
