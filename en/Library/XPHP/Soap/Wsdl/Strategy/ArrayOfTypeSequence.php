...
/**
 * XPHP_Soap_Wsdl_Strategy_ArrayOfTypeSequence
 *
 * @category   XPHP
 * @package    XPHP_Soap
 * @subpackage Wsdl
 ...
 * @license    http://framework.XPHP.com/license/new-bsd     New BSD License
 */
class XPHP_Soap_Wsdl_Strategy_ArrayOfTypeSequence extends XPHP_Soap_Wsdl_Strategy_DefaultComplexType
{
    /**
     ...
     *
     * @throws XPHP_Soap_Wsdl_Exception When no xsd:simpletype can be detected.
     * @param  string $type
     * @return string
     */
