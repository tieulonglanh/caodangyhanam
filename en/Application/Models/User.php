...
class User extends XPHP_Model
{
    ...
    public $district;
    #[Label('Sống trong bán kính')]
    public $within;
    
    #[Label('Nhận Email từ hệ thống')]
    public $sendmail;
   
    public $avatar;
    
    #[Label('Chấp nhận avatar')]
    public $approval;
    ...
    public $status;// 0: mặc định chưa xác thực, 1: đã xác thực email, 2: tài khoản bị khóa, null: tài khoản bị xóa 
